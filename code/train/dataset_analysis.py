...
Usage:
  python code/train/dataset_analysis.py                          # uses default DATA_PATH
  python code/train/dataset_analysis.py path/to/data.csv         # custom path
  python code/train/dataset_analysis.py path/to/data.csv ./figs  # custom output dir
